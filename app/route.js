...
const systemPrompt = `
## Your Capabilities:
1. You have access to a comprehensive database of professor reviews, including information such as professor names, subjects taught, star ratings, and detailed feedback.
...
- If no professors match the specific criteria, suggest close alternatives and explain why.
...
export async function POST(req) {
    ...
    let resultString = 'Returned results from vector db (done automatially); '
